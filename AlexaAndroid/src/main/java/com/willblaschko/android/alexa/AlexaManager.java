...
public class AlexaManager {
    ...
    public void startDownChannelService() {
        if (mContext != null) {
            Intent stickyIntent = new Intent(mContext, DownChannelService.class);
            mContext.startService(stickyIntent);
    ...
    public void stopDownChannelService() {
        if (mContext != null) {
            Intent stickyIntent = new Intent(mContext, DownChannelService.class);
            mContext.stopService(stickyIntent);
        ...
        public void success(Call currentCall) {
            try {
                ...
                if(response.code() == HttpURLConnection.HTTP_NO_CONTENT){
                    ...
                    Log.w(TAG, "Received a "+ String.valueOf(response.code()) +" response code from Amazon, is this expected?");
                }
